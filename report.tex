...
Per quanto riguarda i canali rumorosi, sono stati analizzati due tipi di canale:
il canale con errori non correlati (errori i.i.d.) può essere utilizzato imponendo una
Packet Error Rate a livello applicazione bassa a piacere, variando la quantità di ridondanza aggiunta.
...
in uscita dall'encoder hanno dimensioni inferiori a $K^* \approx 2100$ pacchetti, 
